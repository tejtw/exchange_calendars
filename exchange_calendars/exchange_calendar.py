...
class ExchangeCalendar(ABC):
    ...
    def minutes_count_for_sessions_in_range(
        ...
        """
        return int(self._minutes_per_session[start_session:end_session].sum().total_seconds() / 60)
    ...
    def sessions_in_range(self, start_session_label, end_session_label):
        ...
        """
        # print(start_session_label , end_session_label)
        # print(type(start_session_label))
